...
PhysicsListManager::PhysicsListManager()
  : physics_list_name_("CSPhysicsList"),
    ...
    em_option_deexcitation_ignore_cut_(true),
...
ANLStatus PhysicsListManager::mod_define()
{
  ...
  define_parameter("em_option_deexcitation_ignore_cut", &mod_class::em_option_deexcitation_ignore_cut_);
...
ANLStatus PhysicsListManager::mod_initialize()
{
  ...
  if (em_customized_) {
    ...
    physics_option_.setEMOptions(em_option_fluo_, em_option_auger_, em_option_pipx_, em_option_deexcitation_ignore_cut_);

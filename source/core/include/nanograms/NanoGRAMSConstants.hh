...
constexpr double ktiClockPeriod = 160 * anlgeant4::unit::ns;

// Channel number at each FEC section grid point in image order:
// top-to-bottom rows, left-to-right columns.
constexpr std::array<std::array<int, NUM_CH_EACH_VATA>, NUM_VATA> kFECSectionGridToChannel = {{{0, 8, 23, 24, 39, 40, 55, 63,

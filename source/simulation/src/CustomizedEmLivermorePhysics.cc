...
//
G4_DECLARE_PHYSCONSTR_FACTORY(CustomizedEmLivermorePhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

CustomizedEmLivermorePhysics::CustomizedEmLivermorePhysics(G4int ver, const G4String&)
  : G4VPhysicsConstructor("CustomizedEmLivermore"), verbose(ver),
    e_range_ratio_(0.2), e_final_range_(100.0*um)
{
...
void CustomizedEmLivermorePhysics::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void CustomizedEmLivermorePhysics::ConstructProcess()
{
  ...
  for(const auto& particleName : partList.PartNames()) {
    ...
    if (particleName == "gamma") {
      ...
      eIoni->SetStepFunction(e_range_ratio_, e_final_range_);
